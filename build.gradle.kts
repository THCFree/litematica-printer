...
val buildAll = tasks.create("buildAll") {
    ...
    tasks.findByName(":v1_20:build")?.mustRunAfter(":v1_18:build")
    tasks.findByName(":v1_20_4:build")?.mustRunAfter(":v1_20:build")
    tasks.findByName(":v1_21:build")?.mustRunAfter(":v1_20_4:build")
