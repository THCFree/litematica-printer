...
abstract public class BlockHelper {
    public static List<Class<?>> interactiveBlocks = new ArrayList<>(Arrays.asList(
            ...
            StonecutterBlock.class, AbstractSignBlock.class, AbstractCandleBlock.class, CrafterBlock.class,
            DecoratedPotBlock.class, ChiseledBookshelfBlock.class, VaultBlock.class));
